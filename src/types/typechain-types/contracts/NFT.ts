...
export interface NFTInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "MINP_PRICE", data: BytesLike): Result;
...
export interface NFT extends BaseContract {
  ...
  MINP_PRICE: TypedContractMethod<[], [bigint], "view">;
  ...
  mint: TypedContractMethod<[uri: string], [void], "payable">;
  ...
  ): TypedContractMethod<[uri: string], [void], "payable">;
  getFunction(
